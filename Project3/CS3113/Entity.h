...
enum EntityType   { PLAYER, BLOCK, PLATFORM, UI, NONE };
...
public:
    ...
    Entity(Vector2 position, Vector2 scale, const char *textureFilepath, 
        ...
        EntityType entityType);
    Entity(Vector2 position, Vector2 scale, const char *textureFilepath, 
        TextureType textureType, Vector2 spriteSheetDimensions, std::vector<int> animationAtlas,
        EntityType entityType);
    ~Entity();
    ...
    void moveUp()    {mDirection = UP;    }
    void moveDown()  {mDirection = DOWN;  }
    void moveLeft()  {mDirection = LEFT;  }
    void moveRight() {mDirection = RIGHT; }
    ...
    void setAnimationIndicies(std::vector<int> animationIndicies){
        mAnimationIndices = animationIndicies;
    }
